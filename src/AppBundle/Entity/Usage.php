...
class Usage
{
    ...
    //Debut relation Usage a plusieurs droitVisite
    /**
    * @ORM\OneToMany(targetEntity="DroitVisite", mappedBy="usage", cascade={"persist"})
    */
    ...
    */
    ...
    //Fin relation usage a plusieurs droitVisites
