 ...
 */
class UsageRepository extends EntityRepository
{
    ...
    public function findAllAjax($start, $end, $sCol, $sdir, $search) {
        ...
        $qb = $this->getEntityManager()
            ->createQuery(
                'SELECT r.id, r.libelle, r.code FROM AppBundle:Usage r '
     ...
     public function trouverParLibelle($libelle) {
       try{ 
         $result = $this->getEntityManager()
            ->createQuery(
                'SELECT r FROM AppBundle:Usage r WHERE r.libelle = :libelle'
