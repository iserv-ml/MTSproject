...
/**
 * CategorieControleRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class CategorieControleRepository extends EntityRepository
{
     ...
     public function trouverParLibelle($libelle) {
       try{ 
         $result = $this->getEntityManager()
            ->createQuery(
                'SELECT r FROM AppBundle:CategorieControle r WHERE r.libelle = :libelle'
